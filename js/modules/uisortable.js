        ...
        link: function(scope, element, attrs, ngModel) {
          ...
          if (ngModel) {
            ...
            callbacks.update = function(e, ui) {
                ...
                if(ui.item.index()>=0){
                   // TaskService.setTask(ui.item[0].firstChild.innerHTML,'status',element[0].id);
                   // scope.update();
                }
              ...
              savedNodes.appendTo(element);
                if(ui.item.sortable.moved){
                    console.log(ui.item.sortable.droptarget[0].id);
                    //console.log(ui.item.sortable.moved.name);
                    console.log(ui.item.sortable.moved.name);
